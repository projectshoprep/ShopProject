						...
						<c:forEach var="list" items="${requestScope.list}">
							<div class="single_blog">
								<div class="blog_thumb">
									<a href="blog-details.html"><img src="${list.photopath}"
										alt=""></a>
								...
								<c:if test="${requestScope.paging.previousPageGroup}">
									<li><a
										href="/notice.do?pageNo=${paging.startPageOfPageGroup - 1 }">
											<img src="img/back-button.png" class="before-arrow">
									</a></li>
								</c:if>
								<c:forEach var="m"
								...
								<c:if test="${requestScope.paging.nextPageGroup}">
									<li><a
										href="/notice.do?pageNo=${paging.endPageOfPageGroup + 1 }">
											<img src="img/fast-forward.png" class="next-arrow">
									</a></li>
								</c:if>
							</ul>
						</div>
					...
					<div class="blog_sidebar_widget">
						...
						<div class="widget_list widget_post">
							...
							<div class="post_wrapper">
								<div class="post_thumb">
									<a href="blog-details.html"><img
										src="assets/img/blog/blogs2.jpg" alt=""></a>
								</div>
								<div class="post_info">
									<h4>
							...
							<div class="post_wrapper">
								<div class="post_thumb">
									<a href="blog-details.html"><img
										src="assets/img/blog/blogs3.jpg" alt=""></a>
								</div>
								<div class="post_info">
									<h4>
