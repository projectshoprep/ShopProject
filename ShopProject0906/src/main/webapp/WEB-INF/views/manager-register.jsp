        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                 ...
                 <h3>관리자 회원가입</h3>
                 <form action="manager-register.do">
                 
                 <label>관리자 번호</label><input type="text" name="managerNo"> <br>
                 <lable>관리자 이름</lable><input type="text" name="managerName"> <br>
                  <div class="save_button primary_btn default_button admin-btn"><button
                        type="submit">등록하기</button></div>
                <div class="save_button primary_btn default_button admin-btn"><button
