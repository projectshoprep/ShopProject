						...
						<div id="menu" class="text-left ">
							<ul class="offcanvas_main_menu">
								...
								<ul class="sub-menu">
										...
										<li><a href="login-page.do">login</a></li>
										<li><a href="404.html">Error 404</a></li>
									</ul></li>
				...
				<div class="col-lg-6 col-md-6">
					<div class="account_form register">
						...
						<form action="register.do">
							<p>
								<label>Email address <span>*</span></label><input type="text" name="memberId">
							</p>
							<p>
								<label>Passwords <span>*</span></label><input type="password" name="pw">
							</p>
