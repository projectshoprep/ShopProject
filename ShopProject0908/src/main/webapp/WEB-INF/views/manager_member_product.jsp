...
<title>Manager - 회원 주문 상품 목록</title>
	   						...
	   						<table class="table">
	                               ...
	                               <tfoot>
	                               	<tr>
										...
										<td>
											 <button class="btn btn-info" type="button" onclick="location.href='member-ordre-list-excel.do?search=${requestScope.search}&type=${requestScope.type}'">엑셀 파일 생성</button>
										</td>
									</tr>
	                               </tfoot>
							</table>
