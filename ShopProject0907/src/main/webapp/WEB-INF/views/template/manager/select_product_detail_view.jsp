...
<h2>영화 상세 설정 페이지</h2>
		...
		<p>입고일<input type="text" name="receivingdate" value="${requestScope.product.receivingdate }"placeholder="입고일"></p>
		...
		<p>카테고리<input type="text" name="category" value="${requestScope.product.category }"placeholder="카테고리"></p>
		<p>사이즈<input type="text" name="sizaname" value="${requestScope.product.sizename }"placeholder="사이즈"></p>
		<p>컬러<input type="text" name="color" value="${requestScope.product.color }"placeholder="컬러"></p>
