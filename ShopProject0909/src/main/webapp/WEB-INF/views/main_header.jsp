					...
					<div class="main_menu menu_position">
						<nav>
							<ul>
									...
									<div class="mega_menu">
										<ul class="mega_menu_inner">
											<li>
												...
												<ul>
													<li><a href="shop-fullwidth.html">NEW</a></li>
													<li><a href="shop-fullwidth-list.html">BEST</a></li>
												</ul>
											</li>
											<li>
												...
												<ul>
													<c:forEach var="categorylist" items="${requestScope.clist }" varStatus="status">
														<li><a href="category_detail_view.do?categoryno=${categorylist.categoryno}">${categorylist.categoryno} ${categorylist.categoryname} ${categorylist.gender}</a></li>
													</c:forEach>
												</ul>
											</li>
											<li>
								...
								<li><a href="contact.html">About us<i
										class="fa fa-angle-down"></i></a>
									<ul class="sub_menu pages">
