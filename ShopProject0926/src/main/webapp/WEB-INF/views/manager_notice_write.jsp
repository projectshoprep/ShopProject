                	...
                	<div class="card-body">
						...
						<form action="managerBoardWrite.do" enctype="multipart/form-data" method="post">
							<table>
								<tr>
									<th>제목</th>
									<td><input type="text" name="title" pattern=".{2,60}" title="제목은 2글자 이상 입력해주세요" required></td>
								</tr>
								<tr>
									<th>작성자</th>
									<td>
								...
								<tr>
									<td colspan="2" id="file_form">
										...
										<button type="button" class="btn btn-primary" id="plus">+</button> <button type="button" class="btn btn-primary" id="minus">-</button></p>
